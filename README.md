...
> **Status: v0.3.0-beta.** (currently `b5`) Reading and writing both work
...
```bash
pip install "roombapy-prime@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.3.0b5"
```
...
```bash
pip install "roombapy-prime-tools@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.3.0b5#subdirectory=tools"
```
...
988+ tests, all passing — structural checks against decompiled source,
