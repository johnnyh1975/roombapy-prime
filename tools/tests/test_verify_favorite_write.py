...
from roombapy_prime_tools.verify_favorite_write import _build_recolored_favorite
...
class TestDeleteById:
    ...
    async def test_confirmed_deletion_calls_delete_favorite_with_correct_id(self):
        ...
        from roombapy_prime_tools.verify_favorite_write import delete_by_id
        ...
        with patch(
            "roombapy_prime_tools._cli.login",
            AsyncMock(return_value=MagicMock(robots={})),
        ), patch(
            "roombapy_prime_tools._cli.PrimeFactory.create_prime_robot",
            AsyncMock(return_value=mock_robot),
        ), patch(
            "roombapy_prime_tools._cli.aiohttp.ClientSession", return_value=mock_session
