...
Kurzfassung, Details in `docs/PRIME_APP_GAP_ANALYSIS_2026-07-11.md`:
...
- **Ader-Update-Entwurf** geschrieben (`docs/ADER_UPDATE_DRAFT_2026-07-11.md`).
- Testzahl: 102 (von 95).
...
und `docs/ROOMBAPY_COMPARISON.md`).
...
Siehe `docs/FINDINGS_2026-07-11.md` (Rohbefunde aus der APK-Analyse),
`docs/ROOMBAPY_COMPARISON.md` (Vergleich mit dem echten
`roombapy`-Quellcode), `docs/HA_ROOMBA_PLUS_CROSSREF.md` (Vergleich
mit `ha_roomba_plus`s produktivem `cloud_api.py` — AWS-SigV4,
httpBaseAuth, 403-Retry) und `docs/PRIME_APP_GAP_ANALYSIS_2026-07-11.md`
...
| `aws_sigv4.py` (neu) | Hoch (Algorithmus), unverifiziert (p2maps-Anwendung) | Byte-für-Byte identisch zu `ha_roomba_plus`s produktivem Signierer verifiziert (siehe `docs/HA_ROOMBA_PLUS_CROSSREF.md`) — POST-mit-Body ist aber meine eigene, ungetestete Erweiterung |
...
bleibt: siehe `docs/HA_ROOMBA_PLUS_CROSSREF.md`.
