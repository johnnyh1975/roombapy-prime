...
> **Status: v0.3.0-beta.** (currently `b16`) Reading and writing both work
...
```bash
pip install "roombapy-prime@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.3.0b16"
```
...
```bash
pip install "roombapy-prime-tools@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.3.0b16#subdirectory=tools"
```
...
pip install --upgrade "roombapy-prime-tools@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.3.0b16#subdirectory=tools"

# wrong, if you have the tools -- upgrades half of the pair
pip install --upgrade "roombapy-prime@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.3.0b16"
```
