...
> **Status: v0.2.0-beta.** (currently `b6`) Reading and writing both work
...
```bash
pip install "roombapy-prime@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.2.0b6"
```
...
```bash
pip install "roombapy-prime-tools@git+https://github.com/johnnyh1975/roombapy-prime.git@v0.2.0b6#subdirectory=tools"
```
...
601+ tests, all passing — structural checks against decompiled source,
